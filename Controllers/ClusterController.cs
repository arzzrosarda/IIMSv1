...
namespace IIMSv1.Controllers
{
    public class ClusterController : Controller
    {
        ...
        public async Task<IActionResult> _EditDepartmentCluster(ClusterEditModel model, string returnUrl)
        {
            ...
            TempData["alert"] = Global.GenerateToast(model.ClusterName, "Changes Saved", "topRight", Global.BsStatusIcon.Success, Global.BsStatusColor.Success);
            return LocalRedirect(returnUrl);
        }
        ...
        public async Task<IActionResult> _AddDepartmentCluster(ClusterInputModel model, string returnUrl)
        {
            ...
            TempData["alert"] = Global.GenerateToast(model.ClusterName, "Successfully Saved", "topRight", Global.BsStatusIcon.Success, Global.BsStatusColor.Success);
            return LocalRedirect(returnUrl);
        }
