...
namespace IIMSv1.Controllers
{
    public class DepartmentController : Controller
    {
        ...
        public async Task<IActionResult> ActionSelectedItems(string DeptIds, string Action)
        {
            ...
            if (Action == "Disable")
            {
                ...
                foreach (var id in deptIds)
                {
                    ...
                    .Where(x => x.Employee.departmentID.Equals(id))
                    .ToList();
                    ...
                    GetToast += Global.GenerateToast(dept.Name, "Disabled Successfully", "topRight", Global.BsStatusIcon.Warning, Global.BsStatusColor.Warning);
                }
            ...
            else if (Action == "Enable")
            {
                ...
                foreach (var id in deptIds)
                {
                    ...
                    await _context.SaveChangesAsync(currUser.Id, "Department: Enable");
                    GetToast += Global.GenerateToast(dept.Name, "Enabled Successfully", "topRight", Global.BsStatusIcon.Success, Global.BsStatusColor.Success);
                }
                TempData["alert"] = GetToast;
            }
            else
            {
                ...
                foreach (var id in deptIds)
                {
                    ...
                    GetToast += Global.GenerateToast(dept.Name, "Deleted Successfully", "topRight", Global.BsStatusIcon.Danger, Global.BsStatusColor.Danger);
                }
                TempData["alert"] = GetToast;
            }
            return Json("");
