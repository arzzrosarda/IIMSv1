...
namespace IIMSv1.Controllers
{
    public class DepartmentController : Controller
    {
        ...
        public async Task<IActionResult> _EditDepartment(DepartmentEditModel model, string returnUrl)
        {
            ...
            TempData["alert"] = Global.GenerateToast(department.NormalizedName, "Changes Successfully Saved", "", Global.BsStatusColor.Success, Global.BsStatusIcon.Success);
            return LocalRedirect(returnUrl);
        }
        ...
        public async Task<IActionResult> _DeleteDept(string DeptId, string returnUrl)
        {
            ...
            TempData["alert"] = Global.GenerateToast(department.Name, "Deleted Successfully", "", Global.BsStatusColor.Danger, Global.BsStatusIcon.Danger);
            return LocalRedirect(returnUrl);
        }
        ...
        public async Task<IActionResult> _EnableDept(string DeptId, string returnUrl)
        {
            ...
            if (department != null)
            {
                ...
                TempData["alert"] = Global.GenerateToast(department.Name, "Enabled Successfully", "", Global.BsStatusColor.Success, Global.BsStatusIcon.Success);
            }
            return LocalRedirect(returnUrl);
        }
        ...
        public async Task<IActionResult> _DisableDept(string DeptId, string returnUrl)
        {
            ...
            if (department != null)
            {
                ...
                TempData["alert"] = Global.GenerateToast(department.Name, "Disabled Successfully", "", Global.BsStatusColor.Warning, Global.BsStatusIcon.Warning);
            }
            return LocalRedirect(returnUrl);
        }
        ...
        public async Task<IActionResult> _AddDepartment(DepartmentInputModel model, string returnUrl)
        {
            ...
            TempData["alert"] = Global.GenerateToast(model.Name, "Successfully Added Department", "", Global.BsStatusColor.Success, Global.BsStatusIcon.Success);
            return LocalRedirect(returnUrl);
        }
