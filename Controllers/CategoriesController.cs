    ...
    public class CategoriesController : Controller
    {
        ...
        public async Task<IActionResult> _EditType(string TypeId, string Value)
        {
            ...
            if (itemSpecType != null)
            {
                ...
                TempData["alert"] = Global.GenerateToast(Value, "Successfully saved", "topRight", Global.BsStatusIcon.Success, Global.BsStatusColor.Success);
        ...
        public async Task<IActionResult> _EnableType(string TypeId)
        {
            ...
            if (itemSpecType != null)
            {
                ...
                TempData["alert"] = Global.GenerateToast(itemSpecType.itemSpecType, "Enabled Successfully", "topRight", Global.BsStatusIcon.Success, Global.BsStatusColor.Success);
                return RedirectToAction("Index", "Categories");
            }
            else if (unit != null)
            {
                ...
                TempData["alert"] = Global.GenerateToast(unit.UnitName, "Enabled Successfully", "topRight", Global.BsStatusIcon.Success, Global.BsStatusColor.Success);
                return RedirectToAction("Index", "Categories");
            }
            else if (supplies != null)
            {
                ...
                TempData["alert"] = Global.GenerateToast(supplies.supplyName, "Enabled Successfully", "topRight", Global.BsStatusIcon.Success, Global.BsStatusColor.Success);
                return RedirectToAction("Index", "Categories");
            }
            else
            {
        ...
        public async Task<IActionResult> _DisableType(string TypeId)
        {
            ...
            if (itemSpecType != null)
            {
                ...
                TempData["alert"] = Global.GenerateToast(itemSpecType.itemSpecType, "Disabled Successfully", "topRight", Global.BsStatusIcon.Warning, Global.BsStatusColor.Warning);
                return RedirectToAction("Index", "Categories");
            }
            else if (unit != null)
            {
                ...
                TempData["alert"] = Global.GenerateToast(unit.UnitName, "Disabled Successfully", "topRight", Global.BsStatusIcon.Warning, Global.BsStatusColor.Warning);
                return RedirectToAction("Index", "Categories");
            }
            else if (supplies != null)
            {
                ...
                TempData["alert"] = Global.GenerateToast(supplies.supplyName, "Disabled Successfully", "topRight", Global.BsStatusIcon.Warning, Global.BsStatusColor.Warning);
                return RedirectToAction("Index", "Categories");
            }
            else
            {
        ...
        public async Task<IActionResult> _AddSpecsType(AddSpecinputModel model)
        {
            ...
            else
            {
                ...
                TempData["alert"] = Global.GenerateToast(model.SpecType, "Successfully added in description type", "topRight", Global.BsStatusIcon.Success, Global.BsStatusColor.Success);
                return RedirectToAction("Index", "Categories");
            }
        ...
        public async Task<IActionResult> _AddUnit(AddUnitInputModel model)
        {
            ...
            else
            {
                ...
                TempData["alert"] = Global.GenerateToast(model.Unit, "Successfully added in unit type", "topRight", Global.BsStatusIcon.Success, Global.BsStatusColor.Success);
                return RedirectToAction("Index", "Categories");
            }
        }
        ...
        public async Task<IActionResult> _AddSupply(AddSupplyInputModel model)
        {
            ...
            else
            {
                ...
                TempData["alert"] = Global.GenerateToast(model.Supply, "Successfully added in supply type", "topRight", Global.BsStatusIcon.Success, Global.BsStatusColor.Success);
                return RedirectToAction("Index", "Categories");
            }
